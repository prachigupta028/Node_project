...
const mongoURI =
  "mongodb+srv://PrachiGupta:Prachigupta909087@cluster0.1v1zbfj.mongodb.net/?retryWrites=true&w=majority";
mongoose
  .connect(mongoURI, {
...
//User Registeration post request
...
app.get("/verifyEmail/:id", (req, res) => {
  ...
  jwt.verify(token, "Prachi", async (err, verifiedJwt) => {
    if (err) res.send(err);
...
//User Forgot passwrord post request
...
//User Re-send Verification post request
